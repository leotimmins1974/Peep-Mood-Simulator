...
class Peep:
    def __init__(self, mesh):
        ...
        # Engine Atributes
        self.mesh = mesh
        self.position = [0,0,0] # Should make it randomly around later, but orgin for now
    ...
    def move_to(self, point):
        start = self.position if len(self.movement_actions) == 0 else self.movement_actions[-1]
